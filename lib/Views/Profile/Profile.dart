...
import 'package:job_portal/Views/Profile/addskillspage.dart';
...
class _ProfilePageState extends State<ProfilePage>
  ...
  List<Widget> getItSkills() {
    List<Widget> childs = _apiResponse.data
        .map((e) => Wrap(children: <Widget>[
              Padding(
  ...
  bool isLoadingPopulateKeySkillsProfile;
  populateKeySkills() async {
    setState(() {
      isLoadingPopulateKeySkillsProfile = true;
    });
    _apiResponseKeySkillPopulate = await apiServices.populateKeySkillProfile();
    setState(() {
                                                    ...
                                                    Flexible(
                                                      child: DropdownSearch<
                                                        ...
                                                        onFind: (val) async {
                                                          ...
                                                          return _apiResponseITSkill
                                                              .data;
                                                        },
                                                        hint: "Select Skill",
                                                        onChanged: (value) {
                                                          skillSearchCont.text =
                                                              value.itskillId
                                                                  .toString();
                                                          itSkillId =
                                                              value.itskillId;
