                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                        ...
                        child: Icon(Iconsax.edit5, color: const Color(0xff3e61ed)))
                  ],
                ),
              ),
              Padding(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>LanguagesAdd())).then((value) =>  getLanguage());
                        },
                        child: const Icon(
                          Icons.edit,
                          color: Color(0xff3e61ed),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>AddPatents()));
                        },
                        child: const Icon(
                          Icons.edit,
                          color: Color(0xff3e61ed),
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>AddAwards()));
                        },
                        child: const Icon(
                          Icons.edit,
                          color: Color(0xff3e61ed),
              ...
              children: [
                Row(
                  ...
                  children: [
                    Expanded(
                      child: Text(
                        _apiResponse.data[index].candidateitskillName == "" ? _apiResponse.data[index].itskillName :
                    ...
                    GestureDetector(
                        onTap: () async {
                          ...
                          final insert = LanguagesAddModel(
                            requestType: "delete",
                            candidatelangUuid: _apiResponseLang.data[index].candidatelangUuid,
                          );
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => AddPatents(
                      uuid: _apiResponsePatent.data[index].candidatepatentUuid,
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    ...
                    GestureDetector(
                        onTap: () async {
                          ...
                          final result =
                          await apiServices.patentsAdd(insert);
                          setState(() {
                            isLoading = false;
                          });
                          if (result.data) {
                ...
                Text(_apiResponsePatent.data[index].candidatepatentIssuedate ??
                      "2 years",
                  style: const TextStyle(
                    fontFamily: "ProximaNova",
                    color: Colors.grey,
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => AddAwards(
                      uuid: _apiResponseAwards.data[index].candidateawardUuid,
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        crossAxisAlignment:CrossAxisAlignment.start,
                        children: [
                          Text(_apiResponseAwards.data[index].candidateawardTitle,
                            style: const TextStyle(
                              overflow: TextOverflow.ellipsis,
                              fontFamily: "ProximaNova",
                              fontWeight: FontWeight.bold,
                    ...
                    GestureDetector(
                        onTap: () async {
                          ...
                          final insert = Awards(
                            requestType: "delete",
                           candidateawardUuid: _apiResponseAwards.data[index].candidateawardUuid,
                          );
                ...
                Text(_apiResponseAwards.data[index].candidateawardDate ??
                    "2 years",
                  style: const TextStyle(
                    fontFamily: "ProximaNova",
                    color: Colors.grey,
