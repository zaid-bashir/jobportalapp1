...
class _CareerPreferenceState extends State<CareerPreference> {
                                ...
                                children: <Widget>[
                                  Flexible(
                                    ...
                                    child: DropdownSearch<Industry>(
                                      ...
                                      showSearchBox: true,
                                      popupItemBuilder: (context, Industry item,
                                          bool isSelected) {
                                        return Container(
                                  ...
                                  Flexible(
                                    child: Padding(
                                      ...
                                      child: DropdownSearch<Cities>(
                                        ...
                                        showSearchBox: true,
                                        popupItemBuilder: (context, Cities item,
                                            bool isSelected) {
                                          return Container(
                                            margin: EdgeInsets.symmetric(
                                                horizontal: 8),
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                Expanded(
                                  child: TextField(
                                    decoration:
                                        InputDecoration(hintText: "Thousand"),
                                  ),
                                ),
                              ],
                            ),
                        ...
                        onPressed: () async {
                          if (formKey.currentState.validate()) {
                            ...
                            final insert = CareerPreferencePost(
                              candidateIndustryId: 8,
                              candidateJobtypeIds: '9',
                              candidateEmploymenttypeIds: '3',
                              candidatePreferredCityIds: '4',
                              candidateExpectedctc: 5,
                              candidateShiftId: 6,
                              candidateJoinimmediate: '7',
                            );
                            final result =
  ...
  Widget _listView (BuildContext context){
    return ListView.builder(itemCount: _apiResponse3.data.length,
